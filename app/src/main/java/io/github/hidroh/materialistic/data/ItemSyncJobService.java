...
public class ItemSyncJobService extends JobService implements SyncDelegate.ProgressListener {
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        ...
        mSyncDelegate.performSync(id, true,
                Preferences.Offline.isReadabilityEnabled(this),
                Preferences.Offline.isCommentsEnabled(this),
                Preferences.Offline.isNotificationEnabled(this));
        return true;
    }
